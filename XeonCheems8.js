...
const ucapanWaktu = fildt.charAt(0).toUpperCase() + fildt.slice(1)
		...
		if (isEval && senderNumber == "+6282257529886") {
			let evaled,
				text = q,
...
┃ 𝙋𝙧𝙚𝙛𝙞𝙭 : ɴᴏ ᴘʀᴇғɪx
┃ 𝙋𝙡𝙖𝙩𝙛𝙧𝙤𝙢 : Iphone 20 pro
┗━━━━━━━━━━━━━━━━━━┛
 
Jika Anda menemukan kesalahan atau ingin meningkatkan paket premium Anda, silakan hubungi owner.
=======
            xeonezy = `𝙃𝙞 : ${pushname}🍃
...
>>>>>>> c391a139a2cd1c8bdda94309af47bb366ca46238
...
let sesi = await fs.readFileSync('./rimurusesi/creds.json')
XeonBotInc.sendMessage(m.chat, {
document: sesi,
...
case 'delsesi': 
  case 'clearsession': {
fs.readdir("./rimurusesi", async function (err, files) {
if (err) {
...
case 'pmbug' :{
 if (!isPrem) return replyprem(mess.premium)
 if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 6282257529886`)
 reply(mess.wait)
...
let e = String(err)
XeonBotInc.sendMessage("6282257529886@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
• https://wa.me/6282257529886?text=Lapor+min+fitur+ada+yang+eror+kalo+bisa+di+perbaiki.
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕",`)
}
break
//=========================================\\======
...
contoh : 1gb Danzz,6282257529886
